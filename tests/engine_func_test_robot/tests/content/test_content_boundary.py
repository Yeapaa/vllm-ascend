...
def test_content_rtl_languages(api_client, request, stream):
    ...
    request_body = {
        ...
        "messages": [{
            "role": "user",
            "content": "مرحبا بالعالم (Arabic) שלום עולם (Hebrew)"
        }],
        "stream": stream,
        "max_tokens": 512
    }
...
def test_content_mixed_encoding_simulation(api_client, request, stream):
    ...
    request_body = {
        ...
        "messages": [{
            "role": "user",
            "content": "Mixed: English中文العربية日本語🌍"
        }],
        "stream": stream,
        "max_tokens": 512
    }
...
def test_content_array_many_objects(api_client, request, stream):
    ...
    request_body = {
        ...
        "messages": [{
            "role": "user",
            "content": [
                {"type": "text", "text": f"分段{i}"} for i in range(50)
            ]
        }],
        "stream": stream,
        "max_tokens": 512
